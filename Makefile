...
browser: browser/tdk.js browser/tdk.min.js
...
# Build the browser lib
browser/tdk.js: lib/*.js package.json
	${BROWSERIFY} lib/tdk.js -s tdk -o browser/tdk.js

# Build the browser minified lib
browser/tdk.min.js: browser/tdk.js
	${UGLIFY} browser/tdk.js -o browser/tdk.min.js -m
